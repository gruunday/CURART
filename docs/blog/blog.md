...
2. https://github.com/aeddi/aws-lambda-python-opencv/blob/master/build.sh[lines37-38]
3. https://github.com/aeddi/aws-lambda-python-opencv
4. https://docs.aws.amazon.com/lambda/latest/dg/current-supported-versions.html
